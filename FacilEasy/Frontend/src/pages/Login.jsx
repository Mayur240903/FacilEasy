  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (userType === 'Student') {
        ...
        console.log('Admin type selected:', adminType);
        // Redirect to the appropriate admin dashboard based on admin type
        if (adminType === 'Auditorium Admin') {
          console.log('Redirecting to auditorium admin dashboard');
          navigate('/auditorium-admin-dashboard');
        } else if (adminType === 'Canteen Admin') {
          console.log('Redirecting to canteen admin dashboard');
          navigate('/canteen-admin-dashboard');
        } else if (adminType === 'Sports Admin') {
          console.log('Redirecting to sports admin dashboard');
          navigate('/sports-admin-dashboard');
        } else if (adminType === 'Stationery Admin') {
          console.log('Redirecting to stationery admin dashboard');
          navigate('/stationery-admin-dashboard');
        } else if (adminType === 'Departmental Admin') {
          console.log('Redirecting to department admin dashboard');
          navigate('/department-admin-dashboard');
        } else {
          console.log('Redirecting to generic admin dashboard');
          navigate('/admin-dashboard');
        }
      } else {
        console.log('No user type selected, staying on login page');
      }
    }, 1500);
  };
