  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950' : 'bg-gradient-to-br from-gray-50 to-gray-100'} text-white`}>
      ...
      <div className="flex items-center justify-between p-4 border-b border-blue-900/30 bg-gradient-to-r from-blue-900/80 to-gray-900/90 backdrop-blur-md shadow-lg">
        ...
        <div className="flex items-center">
          <span className="mr-2 text-blue-100 font-medium">Sports Admin</span>
          <div className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center relative overflow-hidden ring-2 ring-blue-300 ring-opacity-50 shadow-lg hover:shadow-blue-500/30 transition-all duration-300 cursor-pointer">
            {profileImage ? (
              ...
              <span className="text-blue-100 font-semibold">S</span>
            )}
                ...
                <div className="mx-4 my-2 p-4 rounded-lg bg-gray-800/50 backdrop-blur-md shadow-lg border border-blue-900/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium truncate text-blue-100">Sports Admin</p>
            ...
            <div className="space-y-6">
                  ...
                  <div className="flex items-start relative z-10">
                    <div className="mr-4">
                      <div className="relative">
                        ...
                        <div className="absolute bottom-0 right-0 h-4 w-4 bg-blue-500 rounded-full border-2 border-gray-800 shadow-md"></div>
                      </div>
                    </div>
                    <div>
                      <h2 className="text-xl font-bold text-blue-100">Sports Admin</h2>
              ...
              <div className="rounded-lg shadow-xl p-6 backdrop-blur-sm bg-gray-800/70 border border-blue-900/20 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="p-4 rounded-lg border-l-4 border-amber-500 mb-3 bg-gray-700/50 shadow-lg hover:shadow-amber-600/20 transition-all duration-300 transform hover:translate-x-1 hover:scale-[1.01] group">
                    <div className="flex justify-between">
                      <div>
                        <h3 className="font-medium text-amber-200">Basketball Court Booking</h3>
                        <p className="text-sm text-gray-300">Basketball Team Practice • May 15, 2023 • 4:00 PM - 6:00 PM</p>
                        <p className="text-sm text-gray-400">Requested by: Prof. Michael Johnson (Physical Education)</p>
                      </div>
                  ...
                  <div className="p-4 rounded-lg border-l-4 border-amber-500 mb-3 bg-gray-700/50 shadow-lg hover:shadow-amber-600/20 transition-all duration-300 transform hover:translate-x-1 hover:scale-[1.01] group">
                    <div className="flex justify-between">
                      <div>
                        <h3 className="font-medium text-amber-200">Equipment Request</h3>
                        <p className="text-sm text-gray-300">Volleyball Set • May 18, 2023 • Event: Inter-Department Tournament</p>
                        <p className="text-sm text-gray-400">Requested by: Dr. Sarah Wilson (Student Affairs)</p>
                      </div>
                      <div className="flex space-x-2">
                        <button className="px-3 py-1 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-md text-sm shadow-md hover:shadow-lg transform hover:translate-y-[-2px] transition-all duration-300 hover:shadow-red-600/30">
                          Reject
              ...
              <div className="flex justify-end mb-4">
                <div className="flex space-x-4">
                  <span className="flex items-center">
                    <span className="w-3 h-3 bg-amber-500 rounded-full inline-block mr-2"></span>
                    Pending: {pendingBookings.length + pendingEquipment.length}
                  </span>
                  <span className="flex items-center">
                      ...
                      {pendingBookings.length > 0 ? (
                        pendingBookings.map(booking => (
                          <tr key={booking.id} className="border-t border-gray-700">
                            ...
                            <td className="p-4">{booking.student}</td>
                            <td className="p-4">{booking.faculty}</td>
                            ...
                            <td className="p-4">
                              <div className="flex space-x-2">
                                <button className="px-3 py-1 bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-200 rounded-md text-sm">
                                  View
                                </button>
                        ...
                        <tr>
                          <td colSpan="8" className="p-4 text-center">
                            <div className="flex flex-col items-center justify-center py-10">
                              ...
                              <p>No pending facility bookings</p>
                              <p className="text-sm text-gray-400">Booking requests will appear here</p>
                            </div>
                          </td>
                        </tr>
                      )}
                      ...
                      {pendingEquipment.length > 0 ? (
                        pendingEquipment.map(request => (
                          <tr key={request.id} className="border-t border-gray-700">
                            ...
                            <td className="p-4">{request.faculty}</td>
                            <td className="p-4">{
                              request.items.map(item => `${item.name} (${item.quantity})`).join(', ')
                            }</td>
                            <td className="p-4">{request.purpose}</td>
                            <td className="p-4">{request.dateNeeded}</td>
                        ...
                        <tr>
                          <td colSpan="8" className="p-4 text-center">
                            <div className="flex flex-col items-center justify-center py-10">
                              ...
                              <p className="text-sm text-gray-400">Equipment requests will appear here</p>
                            </div>
                          </td>
                        </tr>
                      )}
              ...
              {pendingBookings.length > 0 ? (
                <div className="space-y-4">
                  {pendingBookings.map(booking => (
                    <div 
                      key={booking.id}
                      className={`rounded-lg shadow-md overflow-hidden border-l-4 border-green-500 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
                    >
                ...
                <div className="flex flex-col items-center justify-center py-12 bg-gray-800/50 rounded-lg border border-gray-700 shadow-lg">
                  <div className="text-8xl opacity-20 text-green-400">🏟️</div>
                  <p className="mt-4 text-gray-300 text-xl font-light">No facility bookings pending</p>
                  <p className="mt-2 text-gray-500">New booking requests will appear here once submitted</p>
                </div>
              )}
            </div>
          )}
            ...
            <div>
              ...
              {pendingEquipment.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 bg-gray-800/50 rounded-lg border border-gray-700 shadow-lg">
                  ...
                  <p className="mt-4 text-gray-300 text-xl font-light">No equipment requests pending</p>
                  <p className="mt-2 text-gray-500">New equipment requests will appear here once submitted</p>
                </div>
              )}
            </div>
          )}
            ...
            <div>
              ...
              <div className={`rounded-lg overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex flex-col items-center justify-center py-20">
                  ...
                  <p className="text-sm text-gray-400">Approved bookings will appear here</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className={`rounded-lg overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex flex-col items-center justify-center py-20">
                  ...
                  <p className="text-sm text-gray-400">Rejected bookings will appear here</p>
                </div>
              </div>
            </div>
          )}
              ...
              <div className={`rounded-lg overflow-hidden mb-6 relative`}>
                ...
                <div className="absolute bottom-4 left-6 flex items-end">
                  ...
                  <div className="ml-4 text-white">
                    <h2 className="text-2xl font-bold">Sports Admin</h2>
                    ...
                    <div className={`rounded-lg shadow p-6 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} border ${isDarkMode ? 'border-blue-900/20' : 'border-gray-200'}`}>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-200">Sports Complex, Room 101</span>
                        </div>
                      </div>
                    </div>
                  </div>
