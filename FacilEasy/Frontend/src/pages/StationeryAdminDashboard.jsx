...
const StationeryAdminDashboard = () => {
  ...
  // No mock data, these will be populated when connected to the database
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950' : 'bg-gradient-to-br from-gray-50 to-gray-100'} text-white`}>
      ...
      <div className="flex items-center justify-between p-4 border-b border-blue-900/30 bg-gradient-to-r from-blue-900/80 to-gray-900/90 backdrop-blur-md shadow-lg">
        ...
        <div className="flex items-center">
          <span className="mr-2 text-blue-100 font-medium">Stationery Admin</span>
                ...
                <div className="mx-4 my-2 p-4 rounded-lg bg-gray-800/50 backdrop-blur-md shadow-lg border border-blue-900/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium truncate text-blue-100">Stationery Admin</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="rounded-lg shadow-xl p-6 backdrop-blur-sm bg-gray-800/70 border border-blue-900/20 transform transition-all duration-300 hover:shadow-blue-500/10 hover:scale-[1.01] relative overflow-hidden group">
                  ...
                  <div className="flex items-start relative z-10">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-blue-100">Stationery Admin</h2>
                  ...
                  <div className="mt-4 space-y-2 relative z-10">
                    <div className="flex">
                      ...
                      <span className="text-gray-200">Stationery Department</span>
                    </div>
                    <div className="flex">
              ...
              {pendingRequests.length > 0 ? (
                <div className="space-y-4">
                  {pendingRequests.map(request => (
                    <div 
                      key={request.id}
                      className={`rounded-lg shadow-md overflow-hidden border-l-4 border-purple-500 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
                    >
                ...
                <div className="flex flex-col items-center justify-center py-12 bg-gray-800/50 rounded-lg border border-gray-700 shadow-lg">
                  <div className="text-8xl opacity-20 text-purple-400">📝</div>
                  <p className="mt-4 text-gray-300 text-xl font-light">No faculty requests pending</p>
                  <p className="mt-2 text-gray-500">New requests will appear here once submitted</p>
                </div>
              )}
            </div>
          )}
            ...
            <div>
              ...
              <div className={`rounded-lg overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex flex-col items-center justify-center py-20">
                  <div className="text-6xl opacity-20 mb-4">{activeTab === 'approved' ? '✓' : '✕'}</div>
                  <p>No {activeTab === 'approved' ? 'approved' : 'rejected'} requests found</p>
              ...
              <div className={`rounded-lg overflow-hidden mb-6 relative`}>
                ...
                <div className="absolute bottom-4 left-6 flex items-end">
                  ...
                  <div className="ml-4 text-white">
                    <h2 className="text-2xl font-bold">Stationery Admin</h2>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <input 
                            type="text" 
                            className={`w-full p-2 rounded-md ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-100 border-gray-300'} border`}
                            defaultValue={"Stationery Department"}
                          />
                        </div>
                      </div>
                    ...
                    <div className={`rounded-lg shadow p-6 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} border ${isDarkMode ? 'border-blue-900/20' : 'border-gray-200'}`}>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-200">Stationery Department</p>
                        </div>
                        <div>
